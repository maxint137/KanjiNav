...
(function (tmdb_) {
    var NodeType = (function () {
        ...
        NodeType.prototype.next = function () {
            return this === tmdb_.Movie ? tmdb_.Person : tmdb_.Movie;
        };
        NodeType.prototype.makeEdge = function (thisName, otherName) {
            return this === tmdb_.Movie ? new Edge(thisName, otherName) : new Edge(otherName, thisName);
        };
        return NodeType;
    }());
    tmdb_.NodeType = NodeType;
    tmdb_.Movie = new NodeType("movie", "credits", "title", "posters");
    tmdb_.Person = new NodeType("person", "movie_credits", "name", "profiles");
    var Node = (function () {
